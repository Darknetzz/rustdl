...
- **Videos** queue stays pinned at the bottom of the main window (controls scroll above it); the card list scrolls inside the panel and sizes from remaining height after the toolbar. Floating **Videos** window scroll area uses the full window height.
