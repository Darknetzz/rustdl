...
- Floating **Activity log** window: toolbar and log lines use the same explicit top-down body sizing as the floating Videos window (fixes empty panel and controls drifting to the middle).
