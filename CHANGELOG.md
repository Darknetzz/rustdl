...
- Docked video queue panel keeps its dragged height again (footer and log pin to the bottom with a bottom-up layout so egui does not snap the panel back to fit overflowing content).
