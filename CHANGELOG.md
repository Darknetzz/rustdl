...
- Fixed the floating Videos / Convert queue window growing to fill the screen and snapping back on resize (was sizing from viewport `clip_rect` instead of the window body; matches Activity log layout).
